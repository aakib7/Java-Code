 ...
 * @author aaqib
 */
public class EmployeeServices implements EmployeeRecord  {
    ...
    public EmployeeServices() throws ClassNotFoundException, SQLException {
    ...
    public void addEmployee(Employee emp ,Address ad)throws SQLException{
       ...
       preparedStatement = connection.prepareStatement("INSERT INTO employee(id,name, gender, phone, status,salary,post,hour,hourlySalary,type,address) VALUES(?,?, ?, ?, ?,?,?,?,?,?,?)");
...
//        statement = connection.createStatement();
//            int num = statement.executeUpdate("UPDATE employee SET name='', email='' WHERE id=1");
//            System.out.println(num + " Rows updated. ");
    }
