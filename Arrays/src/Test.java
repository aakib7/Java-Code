...
public class Test {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Customer cust=new Customer(account,ammount,name,phone,addres,gender,status,password);
            ...
            case 2:{
                ...
                CustomerEnd cend=new CustomerEnd();
                cend.customerAccountVarificaton();
    ...
    public static void menu4(){
        ...
        System.out.println("Enter 6)fpr BLOCK OR UNBLOCK any customer account:");
